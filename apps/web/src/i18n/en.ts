...
export const en: Record<keyof typeof de, string> = {
  ...
  'review.continue': 'Continue to gaps',
  ...
  'export.aasx': 'AASX package',
  'export.draft': 'Draft',
  'export.gaps': 'Gap report',
  'export.html': 'HTML passport sheet',
  ...
  'hero.gaps.meta': 'overall {present} / {total}',
  ...
  'gaps.showAttribute': 'Show attribute',
