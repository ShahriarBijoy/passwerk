...
- `docs/screenshots/workbench-light-04-review.png`

All five files exist in the repository as of this date, all regenerated by
`SCREENSHOTS=1 pnpm --filter @passwerk/web exec playwright test e2e/screenshots.spec.ts`, which
walks the Musterwerk fixtures at 735 x 800 (the fifth, the review screen again, at 1280 x 900 in
light rather than dark); they replaced the `mcp-app-*.png` set when the workbench redesign
landed, and `docs/media/passwerk-web.gif` in the final fix wave.
